        ...
        <form class=""
            ...
            <div class="bg-light p-3 rounded my-3">
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <input type="text" name="cep_end" value="{{isset($cliente) ? $cliente->cep_end : old('cep_end') }}"
                            class="form-control @error('cep_end') is-invalid @enderror" id="inputCep" placeholder="Digite o CEP" required>
                    </div>
                    <div class="col d-flex align-item-end">
                        <button type="button" class="btn btn-outline-primary text-padrao" onclick="buscarEndereco()">
                            Buscar
                        </button>
                    </div>
                </div>
                ...
                <div class="row my-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="rua_end"
                            value="{{isset($cliente) ? $cliente->rua_end : old('rua_end') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" id="campoEstadoCivil">
                        ...
                        <input type="text" name="estado_civil"
                            value="{{isset($cliente) ? $cliente->estado_civil : old('estado_civil')  }}"
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="email" name="email" value="{{isset($cliente) ? $cliente->email : old('email') }}"
                            class="form-control @error('email') is-invalid @enderror" id="inputEmail" placeholder="exemplo@brasil.com">
                    </div>
                    <div class="col-md-3">
            ...
            <div class="row my-3 ">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button type="submit" class="btn-submit d-block w-100">
                        @if (isset($cliente))
                        Alterar
                        @else
                        Cadastrar
