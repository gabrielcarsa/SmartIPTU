    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="separacaoDebitos">
                ...
                <p>R$ {{number_format($valoresTotais['totalValorReceber'], 2, ',', '.')}}</p>
            </div>
                        ...
                        <form action="" method="post">
                            ...
                            <thead>
                                <tr class="text-center">
                                    <th scope="col"><input type="checkbox" id="selecionar_todos"
                                            name="selecionar_todos" /></th>
                                    <th scope="col">ID</th>
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <th><input type="checkbox" id="" name="checkboxes[]"
                                            value="{{ $resultado->parcela_id }}" />
                                    </th>
                                    @else
                                    <th></th>
                                    @endif
        ...
        <div class="carousel-item">
            ...
            <div class="separacaoDebitos">
                ...
                <p>R$ {{number_format($valoresTotais['totalValorPagar'], 2, ',', '.')}}</p>
            </div>
