...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="row g-3" action="{{ '/contas_receber/cadastrar/' . Auth::user()->id }}" method="post"
            ...
            @csrf
            <div class="col-md-4">
                <label for="inputTitularReceber" class="form-label">Titular da receita*</label>
            ...
            <div class="col-md-4">
                ...
                <select id="inputCliente" name="cliente_id" class="form-select form-control form-control @error('cliente_id') is-invalid @enderror">
