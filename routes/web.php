...
Route::get('/endpoint/categoria_pagar', [ParcelasAPIController::class, 'categoria_pagar']);
...
Route::middleware([
    ...
    'verified',
        ...
        Route::get('/contas_pagar/listar',[ContaPagarController::class, 'contas_pagar_listagem'])->name('contas_pagar.listar');
